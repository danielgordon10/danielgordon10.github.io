...
$(document).ready(function() {
    ...
    $('body').scroll(function(){
        ...
        var shiftAmount = -1*clamp(shiftMax-offset*shiftMax/picHeight, 0, shiftMax) - baseShift;
        ...
        if (!detectMob()) {
          $('#background_image').css('-webkit-filter', 'blur(' + blurAmount + 'px)');
        }
        */
        if (!detectMob()) {
            $('#background_image').css('background-position', '0px ' + (shiftAmount)+ 'px');
        }
