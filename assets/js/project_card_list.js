...
$(document).ready(function() {
    ...
    var lastPathSegment = href.substr(href.lastIndexOf('/') + 1, href.indexOf(".html"));
    if (lastPathSegment == 'index.html' || lastPathSegment == "") {
        ...
        basePath = lastPathSegment.substring(0, lastPathSegment.indexOf(".html")) + "/";
                            ...
                            '<div class="container bg-light">' +
                              '<div class="row shadow-sm">' +
                                '<div class="p-0 col-md-6">' +
                                  ...
                                  '</div>' +
                                '</div>' +
                                '<div class="col-md-6 px-3" onclick="location.href=\'' + data.url + '\';" style="cursor: pointer;">' +
                                  '<div class="row">' +
                                    '<div class="col-md-12">' +
